...
const apiKey = '2eeda9f328e584885484f9aa';


const API_URL= "https://v6.exchangerate-api.com/v6/2eeda9f328e584885484f9aa/latest/"
...
async function convertMoney(){
    ...
    try{
       ...
       const data = await response.json()
        ...
        <div style="font-size: 1.9rem; opacity: 0.8 margin-top 10px;">
        ...
        error.style.display = "block"
        error.innerHTML = `Falha ao converter moeda! Por favor tente novamente mais tarde.`
